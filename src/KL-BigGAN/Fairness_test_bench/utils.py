...
imsize_dict = {'I32': 32, 'I32_hdf5': 32,
               ...
               'C10': 32, 'C100': 32, 'CINIC10': 32, 'STL10': 64, 'C10U': 32, 'CelebA': 32, 'CA64': 64}
...
nclass_dict = {'I32': 1000, 'I32_hdf5': 1000,
               ...
               'C10': 10, 'C100': 100, 'CINIC10': 10, 'STL10': 10, 'C10U': 1, 'CelebA': 1, 'CA64': 1}
...
def get_data_loaders(config, dataset, data_root=None, augment=False, 
                    batch_size=64, num_workers=8, shuffle=True, load_in_mem=False, hdf5=False,
                    pin_memory=True, drop_last=True, start_itr=0,
                    num_epochs=500, use_multiepoch_sampler=False,
                    **kwargs):
    # for now, focus on CA64, had to do a weird thing and feed in config
    assert dataset == 'CA64' and not augment
    ...
    if 'hdf5' in dataset:
        ...
        if augment:
            ...
            if dataset in ['C10', 'C100', 'CINIC10', 'STL10', 'C10U']:
                ...
                balanced_labels_path = DATA_PATH + 'celeba_{}/celeba_balanced_train_labels.pt'.format(bias_split)
                ...
                if config['reweight'] == 1:
                    ...
                    ratio_path = DATA_PATH + 'celeba_{}/celeba_unbalanced_train_density_ratios.pt'.format(bias_split)
