...
def run(config):
    ...
    data_logger.write("Experiment: %s_%s, bias=N.A, data=0 \n"%(config['bias'],config['perc']))
    ...
    # number of classes
    probs_db = np.zeros((10, 10000, n_classes)) #Numper of runs , images per run ,Number of classes
    for i in range(10):
